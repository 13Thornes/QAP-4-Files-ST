...
while True:
    ...
    while True:
        ExtraLiab = input("Would the customer like extra liability insurance, up to $1,000,000 (Y / N): ").upper()
        if ExtraLiab == "":
    ...
    print(f"----------------------------------------------------------------------")
    print()
    print(f"   Policy No: {NEXT_POL_NUM}")
    ...
    print()
    print(f"----------------------------------------------------------------------")
    print(f"   Invoice Date: {InvoiceDateDSP:<10s}           First Payment Due: {FirstPayDate:<10s}")
    print()
    print(f"                              Past Claims")
    print()
